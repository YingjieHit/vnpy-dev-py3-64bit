...
class CtpTdApi(TdApi):
    ...
    def onRspQryTradingAccount(self, data, error, n, last):
        ...
        #通过CTP接口查询账户资金
        vnTrader_dir = 'C:\\ProgramData\\Anaconda3\\Lib\\site-packages\\vnpy-1.7.1-py3.6.egg\\vnpy\\trader\\app\\ctaStrategy\\AccountInfo'# AccountInfo 所在路径
        vnTrader_dir = "D:\\py_workplace\\vnpy-dev-py3-64bit\\vnpy\\trader\\app\\ctaStrategy\\AccountInfo"  # 张英杰修改
