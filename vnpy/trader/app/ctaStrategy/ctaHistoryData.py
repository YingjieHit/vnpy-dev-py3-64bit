...
3. 增加从交易开拓者导出的历史数据载入到MongoDB中的函数
4. 增加从通达信导出的历史数据载入到MongoDB中的函数
"""
...
if __name__ == '__main__':
    ...
    #loadTBCsv('RB88_1min.csv', MINUTE_DB_NAME, 'RB88')
    #loadTBCsv('I88_1min.csv', MINUTE_DB_NAME, 'I88')
    #loadTBCsv('ZC88_1min.csv', MINUTE_DB_NAME, 'ZC88')
    #loadTBCsv('V88_1min.csv', MINUTE_DB_NAME, 'V88')
    #loadTBCsv('HC88_1min.csv', MINUTE_DB_NAME, 'HC88')
    #loadTBCsv('FG88_1min.csv', MINUTE_DB_NAME, 'FG88')
    #loadTBCsv('BU88_1min.csv', MINUTE_DB_NAME, 'BU88')
    #loadTBCsv('IF88_1min.csv', MINUTE_DB_NAME, 'IF88')
    #loadTBCsv('SM88_1min.csv', MINUTE_DB_NAME, 'SM88')
    #loadTBCsv('MA88_1min.csv', MINUTE_DB_NAME, 'MA88')
    #loadTBCsv('A88_1min.csv', MINUTE_DB_NAME, 'A88')
    #loadTBCsv('L88_1min.csv', MINUTE_DB_NAME, 'L88')
    #loadTBCsv('JM88_1min.csv', MINUTE_DB_NAME, 'JM88')
    #loadTBCsv('JD88_1min.csv', MINUTE_DB_NAME, 'JD88')
    #loadTBCsv('RU88_1min.csv', MINUTE_DB_NAME, 'RU88')
    #loadTBCsv('CU88_1min.csv', MINUTE_DB_NAME, 'CU88')
    #loadTBCsv('ZN88_1min.csv', MINUTE_DB_NAME, 'ZN88')
    #loadTBCsv('SR88_1min.csv', MINUTE_DB_NAME, 'SR88')
    #loadTBCsv('CF88_1min.csv', MINUTE_DB_NAME, 'CF88')
    #loadTBCsv('PP88_1min.csv', MINUTE_DB_NAME, 'PP88')
    #loadTBCsv('SF88_1min.csv', MINUTE_DB_NAME, 'SF88')

    #更新品种合约数据
    #loadTBCsv('RB88_1min.csv', MINUTE_DB_NAME, 'rb1805')
    #loadTBCsv('I88_1min.csv', MINUTE_DB_NAME, 'i1801')
    #loadTBCsv('HC88_1min.csv', MINUTE_DB_NAME, 'hc1801')
    #loadTBCsv('JM88_1min.csv', MINUTE_DB_NAME, 'jm1801')
    #loadTBCsv('BU88_1min.csv', MINUTE_DB_NAME, 'bu1712')
    #loadTBCsv('RU88_1min.csv', MINUTE_DB_NAME, 'ru1801')
    #loadTBCsv('J88_1min.csv', MINUTE_DB_NAME, 'j1801')
    #loadTBCsv('NI88_1min.csv', MINUTE_DB_NAME, 'ni1805')
    #loadTBCsv('ZN88_1min.csv', MINUTE_DB_NAME, 'zn1805')
    #loadTBCsv('SF88_1min.csv', MINUTE_DB_NAME, 'SF801')
    #loadTBCsv('SM88_1min.csv', MINUTE_DB_NAME, 'SM801')
    #loadTBCsv('MA88_1min.csv', MINUTE_DB_NAME, 'MA801')
    #loadTBCsv('ZC88_1min.csv', MINUTE_DB_NAME, 'ZC801')
    #导入通达信历史分钟数据
