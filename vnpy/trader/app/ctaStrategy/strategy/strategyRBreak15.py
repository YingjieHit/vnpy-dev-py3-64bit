...
class RBreakStrategy15(CtaTemplate):
    """改进型RBreak策略"""
    className = "RBreakStrategy15"
    autor = "张英杰"
    ...
    def __init__(self, ctaEngine, setting):
        """Constructor"""
        super(RBreakStrategy15, self).__init__(ctaEngine, setting)
    ...
    def onFifteenBar(self, bar):
        ...
        time_last = time_now.replace(hour=14, minute=59, second=0)
