...
fcpp = open('QdpFtdcTraderApi.h', 'r')
ftask = open('qdp_td_task.cpp', 'w')
fprocess = open('qdp_td_process.cpp', 'w')
ffunction = open('qdp_td_function.cpp', 'w')
fdefine = open('qdp_td_define.cpp', 'w')
fswitch = open('qdp_td_switch.cpp', 'w')
fheaderprocess = open('qdp_td_header_process.h', 'w')
fheaderon = open('qdp_td_header_on.h', 'w')
fheaderfunction = open('qdp_td_header_function.h', 'w')
fwrap = open('qdp_td_wrap.cpp', 'w')
